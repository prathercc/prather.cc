      ...
      <Router>
        ...
        >
          ...
          <div style={{ opacity: loading ? 0 : 100 }}>
            <div className='starbend' style={{ position: 'absolute', width: '100%', height: '100%', backgroundImage: `url(https://i92.servimg.com/u/f92/11/29/62/29/stars11.png)`, opacity: 0.45 }} />
            <div className='blackhole2' style={{ position: 'absolute', width: '100%', height: '100%', backgroundImage: `url(https://i92.servimg.com/u/f92/11/29/62/29/blackh16.png)`, opacity: 0.6 }} />
            <div className='blackhole' style={{ position: 'absolute', width: '100%', height: '100%', backgroundImage: `url(https://i92.servimg.com/u/f92/11/29/62/29/blackh16.png)`, opacity: 0.8 }} />
            <Switch>
