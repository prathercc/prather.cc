...
const Admin = ({ setUserData, userData }) => {
    ...
    return (
        <>
            <Nav.Link style={{ fontFamily: fontStyle }} onClick={() => setModalOpen(true)} className='appbarDefault'><AdminIcon style={{ fontSize: getIconSizing('small') }} /> Admin Portal</Nav.Link>
